...
def get_weather(city:str):
    #TODO do a real weather API call
...
#     result = os.system(command)  # use positional argument
#     return result
...
available_tools={
    "get_weather":{
        "fn":get_weather,
        "description":"That takes a city name and returns the weather in that city",
    },
    "run_command":{
        "fn":run_command,
